...
- **default_configs**: Contains the default values for important varaibles such as folder paths and dictionary keys.
- **exploratory_data_analysis**: A Jupyter Notebook used for light data analysis and gaining insights into the dataset.
- **playbooks**: Contains the code that executes the solution. 
- **results**: The results from an execution is written here. 
- **src**: Contains all utility functions and model logic.
- **take_home_challenge_instructions**: A folder containing the PDF instructions for this challenge.
- **user_input**: The required user input. User queries and data columns to filter by. 
- **README.md**: Introduction to my submission. 
- **README_RUN_CODE.md**: Documentation on how to setup and execute the code. 
- **README_THOUGHTS.md**: Full documnetation on solution.
